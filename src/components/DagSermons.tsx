        ...
        <div className="flex flex-col md:grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left space-y-8 animate-on-scroll opacity-0 translate-y-10 transition-all duration-1000 order-2 md:order-1">
            ...
            <div className="flex flex-col items-center md:items-start gap-4 pt-8">
              ...
              >
                <div className="flex items-center justify-center md:justify-start px-8 py-4 bg-white/10 backdrop-blur-md rounded-2xl border border-white/10 transition-all duration-300 hover:bg-white/20 hover:border-white/20 hover:scale-105 transform">
